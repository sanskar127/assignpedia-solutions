...
export default function WhatWeDoOne({ title, paragraph, features = [], image }) {
  const List = ({ text }) => (
        ...
        <div className="border-b border-body-color/[.15] pb-16 dark:border-white/[.15] md:pb-20 lg:pb-28">
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <p className="text-primary mb-2">What We Do</p>
              {/* <SectionTitle title={title} paragraph={paragraph} mb="44px" size="xl" /> */}

              <h3 className="mb-4 text-3xl font-bold !leading-tight text-black dark:text-white sm:text-4xl md:text-[45px]">
                {title}
              </h3>
              <div className="text-base !leading-relaxed text-body-color md:text-lg">{paragraph}</div>
              ...
              <Link href="/about" className="flex">
                <button className="text-white mr-3 text-lg">View More</button>
